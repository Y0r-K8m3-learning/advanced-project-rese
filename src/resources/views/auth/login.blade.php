        ...
        <div class="w-full max-w-md bg-white border border-gray-300 rounded-lg p-6 shadow-md">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <x-text-input id="email" class="block w-full max-w-xs border-0 border-b-2 border-gray-300 focus:border-indigo-500 focus:ring-0 pl-3" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Email" />
                ...
                <div class="flex items-center mb-6">
                    ...
                    <x-text-input id="password" class="block w-full max-w-xs border-0 border-b-2 border-gray-300 focus:border-indigo-500 focus:ring-0 pl-3" type="password" name="password" required autocomplete="current-password" placeholder="Password" />
                    <x-input-error :messages="$errors->get('password')" class="mt-2" />
                </div>

                <!-- Log in Button -->
                <div class="flex items-center justify-end">
                    <x-primary-button class="w-full py-2" style="max-width: 100%;">
                        {{ __('Log in') }}
                    </x-primary-button>
                </div>
            </form>
