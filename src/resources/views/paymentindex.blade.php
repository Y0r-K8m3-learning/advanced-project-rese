            ...
            <div class="col-6 card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="number_of_people" class="form-control" value="1" min="1" readonly
                            </div>

                        <!-- 単価を設定 -->
                        <div class="form-group">
                            <label for="price_per_person">単価</label>
                            <input type="text" id="price_per_person" class="form-control" value="500" readonly>
                        </div>
